...
export IMAGE_URL=${IMAGE_URL-quay.io/mvaldron-rhdh/rhtap-csharp-app-1:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/mvaldron-rhdh/rhtap-csharp-app-1-gitops
